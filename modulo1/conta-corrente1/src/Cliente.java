public class Cliente {
    ...
    public void imprimirContatos(){
            for (Contato contato : contatos){
                System.out.println("Contato:" + contato.descricao + " " + contato.telefone + " " + contato.tipo + "." );
            }
    ...
    public void imprimirEnderecos(){
            for (Endereco endereco: enderecos){
                System.out.println("Endereco: " + endereco.logradouro + " " + endereco.complemento + " " + " número:" + endereco.numero + " " + " cep: " + endereco.cep + " " + endereco.cidade + " " + endereco.estado + " " + endereco.pais + " " + " tipo:" + endereco.tipo);
            }
